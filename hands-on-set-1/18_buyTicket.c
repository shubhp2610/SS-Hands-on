...
----------------------------------
Select train: 1, 2, 3, 4, 5 or enter 0 to exit.
4
Acquiring write lock to prevent double booking.
Write lock acquired. Booking ticket....
Ticket booked! Booking number : 1
...
Acquiring write lock to prevent double booking.
Write lock acquired. Booking ticket....
Ticket booked! Booking number : 2
